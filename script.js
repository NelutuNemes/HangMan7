...
// const easy_radio = document.getElementById("easy");
// const medium_radio = document.getElementById("medium");
// const hard_radio = document.getElementById("hard");
...
function fetch_data_from_api(apiUrl) {
    ...
    fetch(apiUrl)
        ...
        .then(data => {
            ...
            // Amestecăm literele cuvântului ascuns pentru un hint
            // let shuffledWord = random_generated_word;
            // shuffledWord = random_generated_word.split("").sort(() => Math.random() - 0.5);

            // shuffledWord.forEach(function (item) {
            //     let hintSpan = document.createElement("span");
            //     hintSpan.innerText = item;
            //     hint_for_user.appendChild(hintSpan);
            // });

            // console.log(shuffledWord);
            console.log("linia 50");
...
function check_Letter_InWord(letter) {
    ...
    if (random_generated_word.includes(letter)) {
        ...
        // contorizam
        // Adaugă clasa "correct" la span-ul corespunzător
        // let correctSpan = cuvantul_ascuns.querySelectorAll(`span:nth-child(${correct_choice_counter})`);
        ...
        // correct_spans.forEach(function (item) {
...
function resetProgressBar() {
    ...
    // Restul codului pentru actualizarea barei de progres
}
